  ...
  return (
    <section>
      <div className="flex flex-wrap lg:gap-5 sm:gap-1 justify-between lg:pr-60 lg:pl-60 mb-10">
        {services.map((item) => (
          <span className="service-item service-item:hover hover:bg-gray-400">
          {item.label}
        </span>
          ))}
      </div>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
        ...
        <div>
          <form action="" className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-10'>
            ...
            <button class="w-full bg-teal-400 text-white py-3 rounded-lg hover:bg-gray-400 transition md:col-span-2">
          Find Service
        </button>
          </form>
