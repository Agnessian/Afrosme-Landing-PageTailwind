  ...
  return (
    <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
        ...
        <div className=' flex gap-4 text-md leading-normal font-medium font-montserrat max-lg:text-sm wide:mr-24'>
          <a href='/' className="border bg-white border-white px-7 py-3 rounded-lg hover:bg-gray-400 hover:text-black">Find a service</a>
          <a href='/' className="border border-white text-white px-2 py-3 rounded-lg hover:bg-gray-400 hover:text-white">Register as artisan or creative</a>
        </div>
      </div>
